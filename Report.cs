...
namespace ResourceManagement
{
    public partial class Report : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'ResourceManagement_DBDataSet3.Employee_Attendance' table. You can move, or remove it, as needed.
            this.employee_AttendanceTableAdapter.Fill(this.ResourceManagement_DBDataSet3.Employee_Attendance);
        ...
        private void Search_Click(object sender, EventArgs e)
        {
            try
            {
                this.employee_AttendanceTableAdapter.searchData(this.ResourceManagement_DBDataSet3.Employee_Attendance, textSearch.Text);
            }
        ...
        private void comboBoxEditId_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                pictureBox7.Image = new Bitmap("C:\\ResourceManagement\\img\\User Photo\\" + editUserId + ".png");
            }
            catch (Exception ex)
            {
                pictureBox7.Image = new Bitmap("C:\\ResourceManagement\\img\\User Photo\\default.png");
            }
