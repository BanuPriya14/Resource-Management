...
namespace ResourceManagement
{
    public partial class MainForm : Form
    {
        ...
        private void MainForm_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                pictureBoxProfile.Image = new Bitmap("C:\\ResourceManagement\\img\\User Photo\\" + currentUser.id + ".png");
            }
            catch (Exception ex)
            {
                pictureBoxProfile.Image = new Bitmap("C:\\ResourceManagement\\img\\User Photo\\default.png");
            }
