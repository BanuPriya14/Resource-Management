...
namespace ResourceManagement
{
    public partial class EmployeeForm : Form
    {
            ...
            else
            {
                ...
                try
                {
                   ...
                   // Program.con.Close();
                    ...
                    image.Save("C:\\ResourceManagement\\img\\User Photo\\" + id + ".png", System.Drawing.Imaging.ImageFormat.Png);
        ...
        private void buttonEditSave_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    cmd.ExecuteNonQuery();
                    //Program.con.Close();
                    //System.IO.File.Copy(fileName, "E:\\Desktop\\ResourceManagement\\img\\User Photo\\" + id + ".png");
        ...
        private void searchEmployeeToolStripButton_Click(object sender, EventArgs e)
        {
            try
            {
                this.employee_infoTableAdapter.searchEmployee(this.ResourceManagement_DBDataSet.Employee_info, textSearch.Text);
            }
        ...
        private void Search_Click(object sender, EventArgs e)
        {
            try
            {
                this.employee_infoTableAdapter.searchData1(this.ResourceManagement_DBDataSet.Employee_info, textSearch.Text);
            }
            catch (System.Exception ex)
            {
                System.Windows.Forms.MessageBox.Show(ex.Message);
        ...
        private void fillByToolStripButton_Click(object sender, EventArgs e)
        {
            try
            {
                this.employee_infoTableAdapter.FillBy(this.ResourceManagement_DBDataSet.Employee_info);
            }
            catch (System.Exception ex)
            {
                System.Windows.Forms.MessageBox.Show(ex.Message);
