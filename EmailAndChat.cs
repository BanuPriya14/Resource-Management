...
namespace ResourceManagement
{
    public partial class EmailAndChat : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'ResourceManagement_DBDataSet.Employee_info' table. You can move, or remove it, as needed.
            this.employee_infoTableAdapter.Fill(this.ResourceManagement_DBDataSet.Employee_info);
            // TODO: This line of code loads data into the 'ResourceManagement_DBDataSet.Employee_info' table. You can move, or remove it, as needed.
            this.employee_infoTableAdapter.Fill(this.ResourceManagement_DBDataSet.Employee_info);
            // TODO: This line of code loads data into the 'ResourceManagement_DBDataSet3.Employee_info' table. You can move, or remove it, as needed.
            try
            {
                pictureBox2.Image = new Bitmap("C:\\ResourceManagement\\img\\User Photo\\" + currentUser.id + ".png");
                pictureCurrentUser.Image = new Bitmap("C:\\ResourceManagement\\img\\User Photo\\" + currentUser.id + ".png");
            }
            catch (Exception ex)
            {
                pictureBox2.Image = new Bitmap("C:\\ResourceManagement\\img\\User Photo\\default.png");
                pictureCurrentUser.Image = new Bitmap("C:\\ResourceManagement\\img\\User Photo\\default.png");
            }
        }
        ...
        private void userInfoGet(object sender, EventArgs e)
        {
            ...
            if (lb != null)
            {
                ...
                try
                {
                    pictureBox1.Image = new Bitmap("C:\\ResourceManagement\\img\\User Photo\\" + secendUser.id + ".png");
                }
                catch (Exception ex)
                {
                    pictureBox1.Image = new Bitmap("C:\\ResourceManagement\\img\\User Photo\\default.png");
                }
            }
        }
        ...
        private void editOnChange(object sender, EventArgs e)
        {
            ...
            try
            {
                pictureSecendUser.Image = new Bitmap("C:\\ResourceManagement\\img\\User Photo\\" + secendUser.id + ".png");
            }
            catch (Exception ex)
            {
                pictureSecendUser.Image = new Bitmap("C:\\ResourceManagement\\img\\User Photo\\default.png");
            }
        }
