    ...
    public partial class Application : Form
    {
        ...
        private void Notification_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                try
                {
                    pictureBoxUser.Image = new Bitmap("C:\\ResourceManagement\\img\\User Photo\\" + labelId.Text + ".png");
                }
                catch (Exception ex)
                {
                    pictureBoxUser.Image = new Bitmap("C:\\ResourceManagement\\img\\User Photo\\default.png");
                }
